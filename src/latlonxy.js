/*
    * 以下のサイトにて公開されているlatlonxy.jsをES6モジュールとして利用するために組み替えたコード
 ...
 */
const Latlonxy={ 
  latlon2xy: function (latDegree, lonDegree, zone) {
